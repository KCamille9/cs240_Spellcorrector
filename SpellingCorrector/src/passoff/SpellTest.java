...
public class SpellTest {
    ...
    private static final String WORD_FILENAME = "test_files/word.txt";
    private static final String WORDS_FILENAME = "test_files/words.txt";
    private static final String BIG_FILENAME = "test_files/notsobig.txt";
